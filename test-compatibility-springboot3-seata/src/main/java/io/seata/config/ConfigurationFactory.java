...
public final class ConfigurationFactory {
	...
	static {
		LOGGER = LoggerFactory.getLogger(ConfigurationFactory.class);
		LOGGER.info("ConfigurationFactory static: load()");
		load();
	}
	...
	private static void load() {
		...
		try {
			...
			LOGGER.error("load Configuration EnhancedServiceNotFoundException: {}", ignore.getMessage());
		} catch (Exception e) {
			LOGGER.error("failed to load extConfiguration:{}", e.getMessage(), e);
		}
		CURRENT_FILE_INSTANCE = extConfiguration == null ? configuration : extConfiguration;
		LOGGER.info("CURRENT_FILE_INSTANCE: {}", CURRENT_FILE_INSTANCE);
	}
