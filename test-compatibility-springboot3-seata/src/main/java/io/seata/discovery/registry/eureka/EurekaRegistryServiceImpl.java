...
//                        TransportClientFactories transportClientFactories = new RestTemplateTransportClientFactories(
//                                new RestTemplateDiscoveryClientOptionalArgs(
//                                        new DefaultEurekaClientHttpRequestFactorySupplier()
//                                )
//                        );
//                        eurekaClient = new DiscoveryClient(applicationInfoManager, new DefaultEurekaClientConfig(), transportClientFactories);
//                    }
//                } catch (Exception e) {
//                    clean();
